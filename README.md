...
In 2026, HIPE introduces a shared task on **OCR post-correction** for **multilingual historical documents**, hosted in the context of [ICDAR 2026](https://icdar2026.org/). It benchmarks systems that transform noisy OCR output into corrected text in **English, French, and German**, using **paragraph-like text units** rather than isolated lines so that systems can benefit from broader textual context, including in recent **LLM-based approaches**.
